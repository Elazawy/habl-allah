...
export default function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    document.title = 'سياسة الخصوصية — أكاديمية حبل الله';
  }, []);
    ...
    <div dir="rtl" className="min-h-screen" style={{ backgroundColor: 'var(--t-bg)' }}>
      ...
      <section className="faq-hero">
        <div className="faq-hero-inner">
          ...
          <h1 className="faq-hero-title">{page?.title ?? 'سياسة الخصوصية'}</h1>
          <p className="faq-hero-subtitle">
            كيف نحمي بياناتك ونحترم خصوصيتك في أكاديمية حبل الله
          </p>
          {page?.updated_at && (
